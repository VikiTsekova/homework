...
($context["long"] ?? null)) ? (("filter-" . twig_replace_filter($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, true, 45), 45, $this->source), ["/" => "-"]))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "core/themes/seven/templates/classy/content-edit/filter-tips.html.twig", "/var/www/homework/web/core/themes/seven/templates/classy/content-edit/filter-tips.html.twig");
    }
}
